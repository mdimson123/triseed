...
WebUI.setText(findTestObject('Object Repository/Page_Sign in to your account/input_Sign in_loginfmt (3)'), 'Marben.dimson@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_Sign in to your account/input_Sign in_idSIButton9 (3)'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Sign in to your account/div_We couldnt find an account with that username'))
